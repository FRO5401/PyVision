...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__filter_lines_0_lines = self.find_lines_output
        self.__filter_lines_0_min_length = 0.0
        self.__filter_lines_0_angle = [93.88489208633094, 132.6962457337884]

        self.filter_lines_0_output = None

        self.__filter_lines_1_lines = self.find_lines_output
        self.__filter_lines_1_min_length = 0.0
        self.__filter_lines_1_angle = [42.086330935251794, 83.54948805460751]
    ...
    def process(self, source0):
        ...
        # Step Filter_Lines0:
        self.__filter_lines_0_lines = self.find_lines_output
        (self.filter_lines_0_output) = self.__filter_lines(self.__filter_lines_0_lines,
                                                           self.__filter_lines_0_min_length,
                                                           self.__filter_lines_0_angle)

        # Step Filter_Lines1:
        self.__filter_lines_1_lines = self.find_lines_output
        (self.filter_lines_1_output) = self.__filter_lines(self.__filter_lines_1_lines,
                                                           self.__filter_lines_1_min_length,
                                                           self.__filter_lines_1_angle)
